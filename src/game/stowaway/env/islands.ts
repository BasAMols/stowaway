...
export class Islands {
    constructor() {
        ...
        // new LayerAsset({
        //     url: `dist/spa/images/island/island${$.flags.night ? 'Night' : 'Day'}_`, key: 'island2', fromIndex: 0, toIndex: 2, extention: '.png', position: new Vector2(-1900, -330), originalSize: new Vector2(6787, 1933), scale: 1, drawScale: 0.75, depth: 0.6, increment: 0.3,
        //     preTransform: (that) => {
