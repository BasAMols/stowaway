...
export class ShipPart extends CVE {
    ...
    constructor(url: string, parallax: number, private foreground: boolean = false, private roi: { x: number, y: number, width: number, height: number } = { x: 0, y: 0, width: 1783, height: 1541 }) {
        ...
        // void $.loader.loadImage('public/ship/animationDay/' + url).then((image) => {
        //     this.themes.push({
        ...
        //     });
        // });
        // void $.loader.loadImage('public/ship/animationSunSet/' + url).then((image) => {
        //     this.themes.push({
        ...
        void $.loader.loadImage('public/ship/day_' + url).then((image) => {
            this.themes.push({
        ...
        void $.loader.loadImage('public/ship/night_' + url).then((image) => {
            this.themes.push({
        ...
        // void $.loader.loadImage('public/ship/animationSunRise/' + url).then((image) => {
        //     this.themes.push({
