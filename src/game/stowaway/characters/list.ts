...
export const mapLocations: Record<string, [Vector2, number]> = {
    bridgeDeckCabin00: [new Vector2(61.2, 983.31), 15],
    bridgeDeckCabin01: [new Vector2(152.72, 983.31), 15],
    bridgeDeckCabin02: [new Vector2(214.21, 983.31), 15],

    bridgeDeck00: [new Vector2(247.1, 1016.2), 25],
    bridgeDeck01: [new Vector2(332.9, 1016.2), 25],
    bridgeDeck02: [new Vector2(390.1, 1016.2), 25],
    bridgeDeck03: [new Vector2(433, 1016.2), 25],
    bridgeDeck04: [new Vector2(527.38, 1016.2), 25],

    mainDeck00: [new Vector2(547.4, 1059.1), 25],
    mainDeck01: [new Vector2(618.9, 1059.1), 25],
    mainDeck02: [new Vector2(690.4, 1059.1), 25],
    mainDeck03: [new Vector2(761.9, 1059.1), 25],
    mainDeck04: [new Vector2(833.4, 1059.1), 25],
    mainDeck05: [new Vector2(904.9, 1059.1), 25],
    mainDeck06: [new Vector2(976.4, 1059.1), 25],
    mainDeck07: [new Vector2(1047.9, 1059.1), 25],
    mainDeck08: [new Vector2(1119.4, 1059.1), 25],
    mainDeck09: [new Vector2(1190.9, 1059.1), 25],
    mainDeck10: [new Vector2(1262.4, 1059.1), 25],

    gunDeck00: [new Vector2(151.29, 1127.74), 25],
    gunDeck01: [new Vector2(222.79, 1127.74), 25],
    gunDeck02: [new Vector2(294.29, 1127.74), 25],
    gunDeck03: [new Vector2(365.79, 1127.74), 25],
    gunDeck04: [new Vector2(437.29, 1127.74), 25],
    gunDeck05: [new Vector2(508.79, 1127.74), 25],
    gunDeck06: [new Vector2(580.29, 1127.74), 25],
    gunDeck07: [new Vector2(651.79, 1127.74), 25],
    gunDeck08: [new Vector2(723.29, 1127.74), 25],
    gunDeck09: [new Vector2(794.79, 1127.74), 25],
    gunDeck10: [new Vector2(866.29, 1127.74), 25],
    gunDeck11: [new Vector2(937.79, 1127.74), 25],
    gunDeck12: [new Vector2(1009.29, 1127.74), 25],
    gunDeck13: [new Vector2(1080.79, 1127.74), 25],
    gunDeck14: [new Vector2(1152.29, 1127.74), 25],
    gunDeck15: [new Vector2(1223.79, 1127.74), 25],
    gunDeck16: [new Vector2(1295.29, 1127.74), 25],
    gunDeck17: [new Vector2(1366.79, 1127.74), 25],

    orlopDeck00: [new Vector2(151.29, 1189.23), 25],
    orlopDeck01: [new Vector2(222.79, 1189.23), 25],
    orlopDeck02: [new Vector2(294.29, 1189.23), 25],
    orlopDeck03: [new Vector2(365.79, 1189.23), 25],
    orlopDeck04: [new Vector2(437.29, 1189.23), 25],
    orlopDeck05: [new Vector2(508.79, 1189.23), 25],
    orlopDeck06: [new Vector2(580.29, 1189.23), 25],
    orlopDeck07: [new Vector2(651.79, 1189.23), 25],
    orlopDeck08: [new Vector2(723.29, 1189.23), 25],
    orlopDeck09: [new Vector2(794.79, 1189.23), 25],
    orlopDeck10: [new Vector2(866.29, 1189.23), 25],
    orlopDeck11: [new Vector2(937.79, 1189.23), 25],
    orlopDeck12: [new Vector2(1009.29, 1189.23), 25],
    orlopDeck13: [new Vector2(1080.79, 1189.23), 25],
    orlopDeck14: [new Vector2(1152.29, 1189.23), 25],
    orlopDeck15: [new Vector2(1223.79, 1189.23), 25],
    orlopDeck16: [new Vector2(1295.29, 1189.23), 25],
    orlopDeck17: [new Vector2(1366.79, 1189.23), 25],
