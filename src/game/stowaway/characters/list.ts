...
export const mapLocations: Record<string, [Vector2, number]> = {
    ...
    gunDeck00: [new Vector2(151.29, 1127.74 + 2), 25],
    gunDeck01: [new Vector2(222.79, 1127.74 + 2), 25],
    gunDeck02: [new Vector2(294.29, 1127.74 + 2), 25],
    gunDeck03: [new Vector2(365.79, 1127.74 + 2), 25],
    gunDeck04: [new Vector2(437.29, 1127.74 + 2), 25],
    gunDeck05: [new Vector2(508.79, 1127.74 + 2), 25],
    gunDeck06: [new Vector2(580.29, 1127.74 + 2), 25],
    gunDeck07: [new Vector2(651.79, 1127.74 + 2), 25],
    gunDeck08: [new Vector2(723.29, 1127.74 + 2), 25],
    gunDeck09: [new Vector2(794.79, 1127.74 + 2), 25],
    gunDeck10: [new Vector2(866.29, 1127.74 + 2), 25],
    gunDeck11: [new Vector2(937.79, 1127.74 + 2), 25],
    gunDeck12: [new Vector2(1009.29, 1127.74 + 2), 25],
    gunDeck13: [new Vector2(1080.79, 1127.74 + 2), 25],
    gunDeck14: [new Vector2(1152.29, 1127.74 + 2), 25],
    gunDeck15: [new Vector2(1223.79, 1127.74 + 2), 25],
    gunDeck16: [new Vector2(1295.29, 1127.74 + 2), 25],
    gunDeck17: [new Vector2(1366.79, 1127.74 + 2), 25],
